...
const BloomingFlower = ({ style, delay }) => (
  ...
  >
    ...
    >
      ...
      >
        <path
          d="M50 50C50 50 70 30 80 20C90 10 100 30 90 50C80 70 60 80 50 50Z"
          fill="var(--accent-purple)"
          opacity="0.8"
        />
        <path
          d="M50 50C50 50 30 70 20 80C10 90 30 100 50 90C70 80 80 60 50 50Z"
          fill="var(--dark-pink)"
          opacity="0.8"
        />
        <path
          d="M50 50C50 50 70 70 80 80C90 90 100 70 90 50C80 30 60 20 50 50Z"
          fill="var(--accent-purple)"
          opacity="0.6"
        />
        <path
          d="M50 50C50 50 30 30 20 20C10 10 30 0 50 10C70 20 80 40 50 50Z"
          fill="var(--dark-pink)"
          opacity="0.6"
        />
  ...
  return (
    <section
      ...
      style={{
        ...
        overflow: "hidden",
        background:
          "radial-gradient(circle at 50% 50%, rgba(255,240,245,0.5) 0%, rgba(255,255,255,0) 70%)",
      }}
    >
      ...
      >
        ...
        >
          ...
          <motion.h1
            ...
            style={{
              ...
              fontWeight: "800",
              background:
                "linear-gradient(135deg, var(--accent-purple) 0%, var(--dark-pink) 100%)",
        ...
        >
          ...
          <BloomingFlower
            style={{ bottom: "10px", right: "-20px", transform: "scale(0.8)" }}
            delay={1.5}
          />
